...
CREATE TABLE Source.CustomerMgmt (
    ...
    C_TAX_ID NVARCHAR(20),
    C_GNDR NVARCHAR(1),
    C_TIER NVARCHAR(1), -- Adjusted to NUMERIC(1)
    C_DOB NVARCHAR(10),
    --Customer_Id NVARCHAR(256),
    ...
    C_PHONE_1_CTRY_CODE NVARCHAR(3),
    C_PHONE_1_AREA_CODE NVARCHAR(3),
    C_PHONE_1_LOCAL NVARCHAR(10),
    C_PHONE_1_EXT NVARCHAR(5),

    -- Fields from C_PHONE_2_XML
    C_PHONE_2_CTRY_CODE NVARCHAR(3),
    C_PHONE_2_AREA_CODE NVARCHAR(3),
    C_PHONE_2_LOCAL NVARCHAR(10),
    C_PHONE_2_EXT NVARCHAR(5),

    -- Fields from C_PHONE_3_XML
    C_PHONE_3_CTRY_CODE NVARCHAR(3),
    C_PHONE_3_AREA_CODE NVARCHAR(3),
    C_PHONE_3_LOCAL NVARCHAR(10),
    C_PHONE_3_EXT NVARCHAR(5),
